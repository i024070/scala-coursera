...
trait GameDef {
  ...
  case class Pos(row: Int, col: Int) {
    ...
    def deltaRow(d: Int): Pos = copy(row = row + d) //TODO what is copy !?!? copy the same object?
   ...
   */
  sealed abstract class Move  //TODO !?!? what is "sealed" ?
  ...
  case class Block(b1: Pos, b2: Pos) {
     ...
     */
    def legalNeighbors: List[(Block, Move)] = neighbors.filter(_._1.isLegal) //TODO name the parameter or "case class" - how to do
