...
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_List__sci_Map__D = (function(expr, escape, references) {
  _eval: while (true) {
    var x1 = expr;
    if ($is_Lcalculator_Literal(x1)) {
      ...
      if ($s_sc_LinearSeqOptimized$class__contains__sc_LinearSeqOptimized__O__Z(this$1, name)) {
        ...
        var refExp = this.getReferenceExpr__p1__T__sci_Map__Lcalculator_Expr(name, references);
        var this$2 = escape;
        var temp$escape = new $c_sci_$colon$colon().init___O__sci_List(name, this$2);
        expr = refExp;
        escape = temp$escape;
        continue _eval
      }
      ...
      var a = x4.a$2;
      var b = x4.b$2;
      var leftOp = this.eval__Lcalculator_Expr__sci_List__sci_Map__D(a, escape, references);
      var rightOp = this.eval__Lcalculator_Expr__sci_List__sci_Map__D(b, escape, references);
      return (((leftOp !== (NaN)) || (rightOp !== (NaN))) ? (leftOp + rightOp) : (NaN))
    } else if ($is_Lcalculator_Minus(x1)) {
      var x5 = $as_Lcalculator_Minus(x1);
      var a$2 = x5.a$2;
      var b$2 = x5.b$2;
      var leftOp$2 = this.eval__Lcalculator_Expr__sci_List__sci_Map__D(a$2, escape, references);
      var rightOp$2 = this.eval__Lcalculator_Expr__sci_List__sci_Map__D(b$2, escape, references);
      return (((leftOp$2 !== (NaN)) || (rightOp$2 !== (NaN))) ? (leftOp$2 - rightOp$2) : (NaN))
    } else if ($is_Lcalculator_Times(x1)) {
      var x6 = $as_Lcalculator_Times(x1);
      var a$3 = x6.a$2;
      var b$3 = x6.b$2;
      var leftOp$3 = this.eval__Lcalculator_Expr__sci_List__sci_Map__D(a$3, escape, references);
      var rightOp$3 = this.eval__Lcalculator_Expr__sci_List__sci_Map__D(b$3, escape, references);
      return (((leftOp$3 !== (NaN)) || (rightOp$3 !== (NaN))) ? $uD($g["Math"]["pow"](leftOp$3, rightOp$3)) : (NaN))
    } else if ($is_Lcalculator_Divide(x1)) {
      var x7 = $as_Lcalculator_Divide(x1);
      var a$4 = x7.a$2;
      var b$4 = x7.b$2;
      var leftOp$4 = this.eval__Lcalculator_Expr__sci_List__sci_Map__D(a$4, escape, references);
      var rightOp$4 = this.eval__Lcalculator_Expr__sci_List__sci_Map__D(b$4, escape, references);
      return ((((leftOp$4 !== (NaN)) || (rightOp$4 !== (NaN))) || (rightOp$4 !== 0)) ? (leftOp$4 / rightOp$4) : (NaN))
    } else {
...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  ...
  var this$2 = $as_sci_Map($s_sci_MapLike$class__transform__sci_MapLike__F2__scg_CanBuildFrom__O(namedExpressions, f, bf));
  return this$2
});
...
$c_Lcalculator_TweetLength$.prototype.colorForRemainingCharsCount__Lcalculator_Signal__Lcalculator_Signal = (function(remainingCharsCount) {
  ...
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(remainingCharsCount$1) {
    return (function() {
      var remainingCharsCout = $uI(remainingCharsCount$1.apply__O());
      return ((remainingCharsCout < 0) ? "red" : ((remainingCharsCout < 15) ? "orange" : "green"))
    })
  })(remainingCharsCount));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T__Lcalculator_Signal__Lcalculator_Signal = (function(a, b) {
  $m_Lcalculator_Signal$();
  var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, a$1, b$1) {
    return (function() {
      var jsx$2 = $m_Lcalculator_Calculator$();
      var jsx$1 = $as_Lcalculator_Expr(b$1.apply__O());
      $m_sci_List$();
      var xs = new $c_sjs_js_WrappedArray().init___sjs_js_Array([a$1]);
      var this$2 = $m_sci_List$();
      var cbf = this$2.ReusableCBFInstance$2;
      return jsx$2.eval__Lcalculator_Expr__sci_List__sci_Map__D(jsx$1, $as_sci_List($s_sc_TraversableLike$class__to__sc_TraversableLike__scg_CanBuildFrom__O(xs, cbf)), arg$outer.namedExpressions$1$f)
    })
  })(this, a, b));
  return new $c_Lcalculator_Signal().init___F0(expr)
});
